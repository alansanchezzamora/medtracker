// Stand-in family data until patients / history screens read from Supabase.
// The home dashboard now loads live reminders; these remain for other pages.

import type { Dose } from "./schedule/types";

export type { Dose, DoseState, SchedulePatient } from "./schedule/types";

...
const nextConfig: NextConfig = {
  ...
  serverExternalPackages: ["@aws-sdk/client-textract", "twilio"],
  // Browsers often autocomplete localhost:3000 → /home from old history.
  // There is no /home route; send it to the real homepage.
  async redirects() {
